...
``automata.symbol_embedding.base`` module used to map symbols to their
vector representation in a JSON file. This class is an extension of the
``automata.core.base.database.vector.JSONVectorDatabase`` class, it
provides similar functionality with additional methods to handle symbol
embeddings.
