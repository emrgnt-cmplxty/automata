...
PROMPT_TEMPLATE = (
    ...
    f"The only operations you support are create, open, insert, delete, and replace. "
    ...
    f"Valid state transitions are begin -> create/open -> insert, delete, replace -> end"
    f"Here's how you open: open`FILE_PATH;"
    f"Here's how you create: create`FILE_PATH;"
