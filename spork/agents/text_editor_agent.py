...
def make_text_editor_task(instructions: str) -> str:
    task = (
        "You are a text editor agent. You create, edit, and save files. Other LLM agents call you to do editing tasks on local files. You pefrom these tasks by finding the correct files,"
