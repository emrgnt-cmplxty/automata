...
from automata_docs.core.coding.python_coding.python_code_writer import PythonCodeWriter
from automata_docs.core.coding.python_coding.syntax_tree_navigation import find_syntax_tree_node
...
def python_writer():
    ...
    return PythonCodeWriter(retriever)
