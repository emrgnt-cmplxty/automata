...
@pytest.fixture
def sync_context(symbol_graph_static_test):
...
def test_get_all_symbols(symbol_graph_static_test, sync_context):
...
def test_build_real_graph(symbol_graph_static_test, sync_context):
    all_symbols = sorted(
...
def test_build_real_graph_and_subgraph(symbol_graph_static_test, sync_context):
