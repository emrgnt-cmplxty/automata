...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("symbol_rank", "symbol_rank_search", [("ref1", 0.5), ("ref2", 0.4)], [("ref1", 0.5), ("ref2", 0.4)]),
    ],
)
def test_process_queries(symbols, symbol_search, symbol_graph_mock, query_type, method_name, method_return, expected):
