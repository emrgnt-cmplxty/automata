...
def symbols():
    symbols = [
        ...
        # parse_uri_to_symbol("scip-python python automata 75482692a6fe30c72db516201a6f47d9fb4af065 `automata.core.coordinator.tests.test_automata_coordinator`/test().(coordinator)"),
