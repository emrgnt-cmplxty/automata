...
from automata.core.agent.tool_management.python_code_retriever_tool_manager import (
...
def python_retriever_tool_builder():
    ...
    return PyCodeRetrieverToolManager(python_retriever=python_code_retriever)
