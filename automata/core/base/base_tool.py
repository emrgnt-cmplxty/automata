...
class SilentCallbackManager(BaseCallbackManager):
    """A callback manager that does not produce any output."""

    def on_tool_start(self, tool_info, tool_input, *args, **kwargs):
        pass

    def on_tool_error(self, error, *args, **kwargs):
        pass

    def on_tool_end(self, observation, *args, **kwargs):
        pass

    async def on_tool_start_async(self, tool_info, tool_input, *args, **kwargs):
        pass

    async def on_tool_error_async(self, error, *args, **kwargs):
        pass

    async def on_tool_end_async(self, observation, *args, **kwargs):
        pass
...
class BaseTool(BaseModel):
    ...
    verbose: bool = False
    callback_manager: BaseCallbackManager = Field(default_factory=SilentCallbackManager)
