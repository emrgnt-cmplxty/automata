...
from automata.core.experimental.search.symbol_search import (
    ExactSearchResult,
    SourceCodeResult,
    SymbolRankResult,
...
class SymbolSearchToolkit(AgentToolkitProvider):
...
class SymbolSearchOpenAIToolkit(SymbolSearchToolkit, OpenAIAgentToolkitProvider):
