...
#         if query_to_symbol_similarity is None:
#             return {k: 1.0 / node_count for k in stochastic_graph}
#         return self._extracted_from__prepare_dangling_weights_27(
#             query_to_symbol_similarity,
#             "query_to_symbol_similarity dictionary must have a value for every node. Missing nodes ",
#         )
...
#         return self._extracted_from__prepare_dangling_weights_27(
#             dangling,
#             "Dangling node dictionary must have a value for every node. Missing nodes ",
#         )

#     # TODO Rename this here and in `_prepare_query_to_symbol_similarity` and `_prepare_dangling_weights`
#     def _extracted_from__prepare_dangling_weights_27(self, arg0, arg1):
#         if missing := set(self.graph) - set(arg0):
#             raise NetworkXError(f"{arg1}{missing}")
#         s = sum(arg0.values())
#         return {k: v / s for k, v in arg0.items()}
